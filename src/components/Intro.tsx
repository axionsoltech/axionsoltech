  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full md:w-[80%] max-w-7xl px-4 sm:px-6">
        <div className="font-display flex flex-col flex-wrap gap-6 text-2xl leading-[0.9] font-bold tracking-tighter uppercase min-[400px]:text-3xl sm:gap-10 sm:text-5xl sm:whitespace-nowrap md:text-6xl lg:gap-12 lg:text-[5.5rem] xl:text-[6.5rem]">
          {/* Line 1: WE TURN + Server Image */}
          <motion.div
            style={{ opacity: o1, x: reducedMotion || isTouch ? 0 : x1 }}
            className="flex items-center justify-start gap-2 sm:gap-8"
          >
          ...
          <motion.div
            ...
            className="flex items-center justify-end gap-2 sm:gap-8"
          >
            <div className="group relative mt-4 flex items-center justify-center rounded-full border border-red-500/40 bg-red-500/10 px-4 py-2 shadow-[0_0_30px_rgba(239,68,68,0.15)] backdrop-blur-sm sm:px-12 sm:py-6">
          ...
          >
            ...
            <div className="group border-accent/50 bg-accent/10 relative mt-4 flex items-center justify-center rounded-full border px-4 py-2 shadow-[0_0_40px_rgba(var(--accent),0.2)] backdrop-blur-sm sm:px-12 sm:py-6">
          ...
          <motion.div
            ...
            className="flex items-center justify-end gap-2 text-white sm:gap-8"
          >
